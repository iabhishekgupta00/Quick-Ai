...
const RemoveBackground = () => {
    ...
    const onSubmitHandler =async (e)=>{
        ...
        try {
            ...
            const{data} = await axios.post("/api/ai/remove-background-image",formData,{
                headers:{
    ...
    return (
        ...
        text-slate-700' >
            ...
            border border-gray-200'>
                ...
                <p className='text-xs text-gray-500 font-light mt-1'>Supports: .jpg, .jpeg, .png, .webp images format</p>
                ...
                px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
                    ...
                    animate-spin border-2 border-t-transparent'></span> :<Eraser className='w-5'/>}
                    Remove Background
                </button>
            </form>
            ...
            flex flex-col border border-gray-200  min-h-96'>
               ...
               {!content ? ( <div className='flex-1 flex justify-center items-center'>
                    ...
                    text-gray-600'>
                         ...
                         <p>Generated Image without background</p>
