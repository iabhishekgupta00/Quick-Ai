...
const AiTools = () => {
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            ...
            <p className='text-gray-500 max-w-lg mx-auto'>Generate engaging content with our AI tools, saving you time and effort while delivering top-notch results.</p>
            </div>
            <div className='flex flex-wrap  mt-10 justify-center'>
                {AiToolsData.map((tool,index) => (
                    ...
                    transition-all  duration-300 cursor-pointer' onClick={()=> user && navigate(tool.path)}>
                        ...
                        <p className='text-gray-500 max-w-[95%] text-sm'>{tool.description}</p>
                    </div>
