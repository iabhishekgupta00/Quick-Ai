...
const CreationItem = ({item}) => {
    ...
    return (
        ...
        rounded-lg cursor-pointer' onClick={()=>setExpanded(!expanded)}>
            <div className='flex justify-between items-center gap-4'>
                ...
                <button className='bg-[#EFF6FF] border border-[#BFDBFE] text-[#1E40EF]
            ...
            </div>
            {
                expanded && (
                    <div>
                        {item.type === 'image' ? (
                            <div>
                                <img src={item.content} alt="image" className='w-full mt-3 
                                max-w-md' />
                            </div>
                            ) : (
